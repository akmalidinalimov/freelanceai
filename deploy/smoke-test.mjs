...
const CHECKS = [
  ...
  { group: "Search", name: "AI match page renders", method: "GET",
    path: "/uz/search?q=AI%20reklama%20roligi", expect: 200, contains: "moslik" },
  { group: "Search", name: "match API validates (same-origin)", method: "POST",
    path: "/api/search/match", origin: true, expect: [400, 422] },
  ...
  { group: "Guards", name: "admin disputes gated", method: "GET", path: "/uz/admin/disputes", expect: 307 },
  { group: "Guards", name: "admin search-debug gated", method: "GET", path: "/uz/admin/search-debug", expect: 307 },
  ...
  { group: "API", name: "edit gig", method: "PATCH", path: "/api/gigs/abc", origin: true, expect: 401 },
  ...
  { group: "API", name: "instagram connect", method: "GET", path: "/api/instagram/connect", expect: 401 },
  { group: "API", name: "instagram disconnect", method: "POST", path: "/api/instagram/disconnect", origin: true, expect: 401 },
  { group: "API", name: "cron instagram-sync", method: "POST", path: "/api/cron/instagram-sync", expect: 401 },
  { group: "API", name: "events validates", method: "POST", path: "/api/events", origin: true, expect: [400, 422] },
